...
# TokenSkip Settings
ADAPTER_PATH="../LLaMA-Factory/saves/qwen/lora/lora_sft_llmlingua2_R1_Qwen_7B_lr_5e-5"
COMPRESSION_RATIO=0.9


CUDA_VISIBLE_DEVICES=4 python evaluation.py --output-dir ${OUPTUT_DIR} --model-path ${MODEL_PATH} --tokenizer-path ${MODEL_PATH} \
